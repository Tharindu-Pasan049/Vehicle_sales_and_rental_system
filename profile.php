...
<title>Vehicle Sales&Rental | My Profile</title>
<!--Bootstrap -->
...
<section class="user_profile inner_pages">
  ...
  <div class="col-md-9 col-sm-9">
    ...
    <div class="user_profile_info gray-bg padding_8x8_40">
      <div class="upload_user_logo"> <img src="assets/images/dealer1-logo.jpg" alt="image">
      </div>

      <div class="dealer_info">
        <h3><?php echo htmlentities($result->FullName);?></h3>
        <h6><?php echo htmlentities($result->ContactNo);?></h6>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Edit Profile </h5>
          <?php  
