...
<title>Vehicle Sales&Rental | Vehicle Details</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          ...
          echo '<div style="font-size:1.5em;color:black">Per Day </div>';}
          else{
            echo htmlentities($result->PricePerDay);
         }
    ...
    <aside class="col-md-3">
      ...
      <div class="sidebar_widget">
        ...
        <?php if($result->VehicleStatus=='rent')
            {?>
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Vehicle Description </a></li>
