...
$sql = "SELECT id from tblvehicles  where tblvehicles.BookingStatus!=1";
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> Vehicles</span></p>
</div>
</div>

<?php $sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblvehicles.BookingStatus!=1";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
{ 
  ...
  ?>
      ...
      <!--Side-Bar-->
      <aside class="col-md-3 col-md-push-1.5">
...
<
              ...
              <div class="form-group select">
                <select class="form-control" name="selecttype">
                  <option>For Rental / Purchasing</option>
<option value="rent">Rental</option>
<option value="sell">Purchasing</option>
<
                </select>
              </div>
