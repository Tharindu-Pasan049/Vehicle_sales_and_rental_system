			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Purchase Bookings</h2>
...
echo htmlentities('Confirmed');
 	...
 	echo htmlentities('Cancelled');
										...
										<td><a href="manage-purchase.php?aeid=<?php echo htmlentities($result->id);?>&vaeid=<?php echo htmlentities($result->vid);?>" onclick="return confirm('Do you really want to Confirm this booking')"> Confirm</a> /


<a href="manage-purchase.php?eid=<?php echo htmlentities($result->id);?>&veid=<?php echo htmlentities($result->vid);?>" onclick="return confirm('Do you really want to Cancel this Booking')"> Cancel</a>
</td>
