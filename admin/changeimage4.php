...
<head>
	...
	<title>Vehicle Sales&Rental | Admin Update Image 4</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT id,Vimage4 from tblvehicles where tblvehicles.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage4);?>" width="300" height="200" style="border:solid 1px #000">
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" onclick="window.location='edit-vehicle.php?id=<?php echo $result->id;?>'" >Back</button>
