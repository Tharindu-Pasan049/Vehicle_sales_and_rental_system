...
$sql="update tblvehicles set VehiclesTitle=:vehicletitle,VehiclesBrand=:brand,VehiclesOverview=:vehicleoverview,PricePerDay=:priceperday,FuelType=:fueltype,ModelYear=:modelyear,SeatingCapacity=:seatingcapacity,VehicleStatus=:vehiclestatus,VehicleType=:vehicletype,AirConditioner=:airconditioner,PowerDoorLocks=:powerdoorlocks,AntiLockBrakingSystem=:antilockbrakingsys,PowerSteering=:powersteering,DriverAirbag=:driverairbag,PassengerAirbag=:passengerairbag,PowerWindows=:powerwindow,CDPlayer=:cdplayer,CentralLocking=:centrallocking where id=:id ";
...
<head>
	...
	<title>Vehicle Sales&Rental | Admin Edit Vehicle Info</title>
...
<div class="form-group">
<label class="col-sm-2 control-label">Vehicle For Rent/Sell<span style="color:red">*</span></label>
<div class="col-sm-4">
<select class="selectpicker" name="vehiclestatus" required>
<option value="<?php echo htmlentities($results->VehicleStatus);?>"> <?php echo htmlentities($result->VehicleStatus);?> </option>
...
<option value="<?php echo htmlentities($results->VehicleType);?>"> <?php echo htmlentities($result->VehicleType);?> </option>
